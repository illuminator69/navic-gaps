...
actual class ConnectivityManager(
	...
	// iOS is out of scope for these downloads; report "charging" so the charging-only gate never
	// blocks the (untested) iOS path. Replace with UIDevice.batteryState monitoring if iOS ships.
	actual val isCharging: kotlinx.coroutines.flow.StateFlow<Boolean> =
